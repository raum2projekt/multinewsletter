...
<head>
	...
	<script type="text/javascript"><?php print file_get_contents($REX['HTDOCS_PATH'] . $REX['MEDIA_ADDON_DIR'] .'/multinewsletter/template/jquery-2.1.4.min.js'); ?></script>
	<link rel="icon" href="<?php echo seo42::getMediaFile("favicon.ico"); ?>">
	<style type="text/css"><?php print file_get_contents($REX['HTDOCS_PATH'] . $REX['MEDIA_ADDON_DIR'] .'/multinewsletter/template/bootstrap.min.css'); ?></style>
	<style type="text/css"><?php print file_get_contents($REX['HTDOCS_PATH'] . $REX['MEDIA_ADDON_DIR'] .'/multinewsletter/template/style.css'); ?></style>
</head>
...
<body class="newsletter">
	...
	<footer>
		<div class="container">
			<div class="row" data-match-height>
				<?php
					$impressum = OOArticle::getArticleById($impressum_id);
	...
	<script type="text/javascript"><?php print file_get_contents($REX['HTDOCS_PATH'] . $REX['MEDIA_ADDON_DIR'] .'/multinewsletter/template/bootstrap.min.js'); ?></script>
	<script>
		$(window).on("load",
			function(e) {
