...
if ($func == 'edit') {
	...
	$form->addRawField(raw_field(rex_i18n::msg('multinewsletter_archive_subject'),
		html_entity_decode($result_archive->getValue("subject"))));

	// Inhalt
	$form->addRawField(raw_field(rex_i18n::msg('multinewsletter_archive_htmlbody'),
			'<a href="'. rex_url::currentBackendPage() .'&func=shownewsletter&shownewsletter='. $entry_id .'" target="_blank">'. rex_i18n::msg('multinewsletter_archive_output_details') .'</a>'));
	...
	// Erstellungsdatum
	$form->addRawField(raw_field(rex_i18n::msg('multinewsletter_newsletter_preparedate'),
	...
	$form->addRawField(raw_field(rex_i18n::msg('multinewsletter_archive_redaxo_sender'),
			$result_archive->getValue("sentby")));
