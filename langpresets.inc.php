<?php
$REX['MULTINEWSLETTER_LANG_PRESETS'] = array(
	array(
		'code' => 'de',
		'language' => 'Deutsch',
		'sendername' => '',
...
<ul>
<li>auf den entsprechenden Adressbuch-Link neben der Absenderadresse oder</li>
<li>mit der rechten Maustaste oben auf die Absenderadresse und wählen im daraufhin erscheinenden Pop-up-Menü den Punkt „Zum Adressbuch hinzufügen“.</li>
</ul>
<p>So entgeht Ihnen garantiert keine Ausgabe unseres Newsletters!</p>
<br>
<p>Falls Sie den Newsletter nicht erhalten wollen, brauchen Sie nichts zu tun.</p>
<br>
<p>Vielen Dank,</p>
<br>
...
<ul>
<li>on the corresponding address book link near the sender address
or</li>
<li>right click the mouse over the sender address and on the displayed Pop-up menu, select the item "Add sender to address book".</li>
</ul>
<p>This will ensure that you do not miss any edition of our Newsletters!</p>
<p>If you don’t want to receive this Newsletter, you don’t need to do anything. You will need to click on the link to confirm that you wish to subscribe.</p>
<br>
<p>Sincerely, yours</p>
<br>
<p>Newsletter-Team</p>',
